/*!
 * Gulp automation for Bootstrap (Sass) development. Also has Drupal Bootstrap3
 * development built-in, please look at usage to know how.
...
class Sass {
   ...
   * Sourcemap (or not based on arg passed), then runs the sass preprocessor.
   * This task does not watch any files, that job is done by other task
   * sass-watch.
   * ---------------------------------------------------------------------------
   */
  preprocess() {
